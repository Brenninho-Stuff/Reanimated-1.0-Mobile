...
//objects Plus
import objectsplus.GhostEffectDoubleNote;
...
class PlayState extends MusicBeatState
{
	...
	public var lerpTweens:Array<NumTween> = [null];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'schoolEvilErect': new SchoolEvilErect();		//Week 6 - ErectStage
	...
	private function generateStaticArrows(player:Int):Void
	{
		...
		for (i in 0...4)
		{
			...
			if (player == 1) {
				...
				if (strumCover != null) playerCovers.add(strumCover);
			} else {
				...
				if (strumCover != null) opponentCovers.add(strumCover);
			}

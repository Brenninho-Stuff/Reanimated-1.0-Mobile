...
import torchsthings.objects.import torchsthings.objects.effects.ReflectedChar;
;
...
class PhillyStreets extends BaseStage
{
	...
	{
		reflectedBF = new import torchsthings.objects.effects.ReflectedChar;
(boyfriend, 0.35);
